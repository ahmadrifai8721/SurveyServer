            ...
            <div class="col-xl-3 col-lg-4">
                <div class="card tilebox-one">
                    <div class="card-body">
                        ...
                        <h6 class="mt-0 text-uppercase">User Active</h6>
                ...
                <div class="card tilebox-one">
                    <div class="card-body">
                        <i class='uil uil-users-alt float-end'></i>
                        <h6 class="mt-0 text-uppercase">Responden</h6>
                ...
                <div class="card tilebox-one">
                    <div class="card-body">
                        ...
                        <h6 class="mt-0 text-uppercase">Diunduh</h6>
                ...
                <div class="card tilebox-one">
                    <div class="card-body">
                        <i class='uil uil-download-alt float-end'></i>
                        <h6 class="mt-0 text-uppercase">Survey</h6>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card card-h-100">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3 header-title">Hasil Survey</h4>

                        <div dir="ltr">
                            <div id="surveyChart" class="mt-3 apex-charts" data-colors="#0acf97,#727cf5,#ffbc00,#fa5c7c">
                            </div>
                        </div>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card card-h-100">
                    <div class="card-body">
                        ...
                        <h4 class="mb-3 header-title">Rekap Pendataan Food Recal</h4>

                        <div dir="ltr">
                            <div id="foodRecalChart" class="mt-3 apex-charts" data-colors="#0acf97,#727cf5,#ffbc00,#fa5c7c">
                            </div>
                        </div>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
                ...
                <div class="card">
                    ...
                    <div class="pt-0 card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-sm table-centered font-14">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="card">
                    <div class="d-flex card-header justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0);" class="btn btn-sm btn-light">Export <i class="mdi mdi-download ms-1">
                            </i></a>
                    </div>
...
@section('js')
    ...
    <script>
        var options = {
            series: [{
                name: "Food Recal Report",
                data: [
                    @foreach ($foodRecallReport as $key => $value)
                        {!! $value !!},
                    @endforeach
                ]
            }],
        ...
        var chart = new ApexCharts(document.querySelector("#foodRecalChart"), options);
        chart.render();
    </script>
@endsection
@section('plugins')
